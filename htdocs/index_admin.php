...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-danger">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index_admin_addgame.php">Add Games + <span class="sr-only">(current)</span></a>
            </li>
    ...
    <form action="logout.php" method="POST" accept-charset="UTF-8" id="login-nav">

        <p><button type="submit" class="btn btn-info" data-toggle="modal""><b>Logout</b></button></p>
    </form>
    </div>
</nav>
...
<main role="main">
    ...
    <div class="container">
        ...
        <img src="https://cdn0.iconfinder.com/data/icons/male-user-action-icon-set-1-ibrandify/512/8-512.png" class="img-thumbnail" alt="Cinque Terre" style="width:30%">
