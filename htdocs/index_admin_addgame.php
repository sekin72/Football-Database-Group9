...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-danger">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Add Games + <span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="jumbotron">
        <div class="container ">
            <div class="row">
                ...
                <label for="Player ID">Game ID</label>
                <input value='' id="Player ID" placeholder="ID" type="text" class="form-control" />

                <label for="Your Transfer-Fee">Date</label>
                <input id="Date" value='' placeholder="Date" type="text" class="form-control" />

                <label for="Your Transfer-Fee">Score</label>
                <input id="Score" value='' placeholder="Score" type="text" class="form-control" />

                <label for="Your Transfer-Fee">Arena</label>
                <input id="Arena" value='' placeholder="Arena" type="text" class="form-control" />

                <label for="Your Transfer-Fee">League ID</label>
                <input id="Arena" value='' placeholder="ID" type="text" class="form-control" />

                <label for="Your Transfer-Fee">Home Team</label>
                <input id="Arena" value='' placeholder="Home Team" type="text" class="form-control" />

                <label for="Your Transfer-Fee">Away Team</label>
                <input id="Arena" value='' placeholder="Away Team" type="text" class="form-control" />

                <input type="submit" class="btn btn-success btn-login-submit"data-toggle="modal" data-target="#login-modal" value="Add Game!" />
                ...
                <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="loginmodal-container">
                            <label> <big> <p class="text-danger">Game is added..</p> </label> <big/>
                        </div>
                    </div>
                </div>
