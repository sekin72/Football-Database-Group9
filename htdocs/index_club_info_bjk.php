...
<main role="main">
    ...
    <div class="container-fluid">
        ...
        <h1>Beşiktaş J.K.</h1>
        <p>Football Club Information</p>
        <div class="row">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel-body" style="text-align:center;margin: auto;width: 100%;   padding: 30px;">
                <img class="pull-center" src="http://i.hurimg.com/i/hurriyet/75/590x332/5a4b5bb62269a22be03f1585.jpg" style="width:45%" height="45%">
            </div>
                <div class="panel-body" style="text-align:center;margin: auto;width: 100%;   padding: 30px;">
                    <div class="col-lg-10 col-lg-offset-1">
                        <thead>
                        <tr>
                            <th>Name: Beşiktaş J.K.</th><br/>
                            <th>Colors: Black and White</th><br/>
                            <th>Establishment Date: 19/03/1903</th><br/>
                            <th>Stadium: Vodafone Park</th><br/>
                            <th>Number Of Cups: 51</th><br/>
                            <th>Number Of Stars: 3</th><br/>
                        </tr>
                        </thead>
                    </div>
                </div>
